...
import com.vulcabras.schedule.repository.JobExecutionRepository;
import com.vulcabras.schedule.repository.JobRepository;
...
public class JobScheduleService {
    ...
    private Trigger createTrigger(JobRequest jobRequest) throws Exception {
